...
<html lang="en">
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css">
    ...
    <br>
      ...
      <figure class="text-center" my-> <h1>Quotation software </h1><h2>Hair products</h2> 
      </figure>
    ...
    <body>
      ...
      <div class="container">
        ...
        <button class="my-button my-2" align-items="center"> <a href= "add_product.php" class= text-light> Add product </a></button>
 ...
 if($result){
  while($row=mysqli_fetch_assoc($result)){
   ...
   echo '<tr>
      ...
      <td>'.$p_description.'</td>
      <td>'.$p_price.'</td>
      <td> <button class="btn btn-primary"> <a href="update_product.php? updateid='.$p_id.'" class= "text-light">Update</a></button>
      <button class="btn btn-danger"> <a href="delete.php? deleteid='.$p_id.'" class= "text-light">Delete</a></button> </td>
